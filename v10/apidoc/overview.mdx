...
<CardGroup cols={2}>
  ...
  <Card 
    ...
    href="/v10/apidoc/convert-incident"
  >
  ...
  <Card 
    ...
    icon="chart-bar"
    href="/v10/apidoc/property-values"
  >
...
<Card 
  ...
  icon="download"
  href="/images/downloads/UTMStack_Alerts_API.postman_collection.json"
>
...
If you prefer to access the collection file directly:

<CodeGroup>

```bash wget
# Download using wget
wget https://your-docs-site.com/images/downloads/UTMStack_Alerts_API.postman_collection.json
```

```bash curl  
# Download using curl
curl -O https://your-docs-site.com/images/downloads/UTMStack_Alerts_API.postman_collection.json
```

```powershell PowerShell
# Download using PowerShell
Invoke-WebRequest -Uri "https://your-docs-site.com/images/downloads/UTMStack_Alerts_API.postman_collection.json" -OutFile "UTMStack_Alerts_API.postman_collection.json"
```

```javascript JavaScript
// Download programmatically
const response = await fetch('https://your-docs-site.com/images/downloads/UTMStack_Alerts_API.postman_collection.json');
const collection = await response.json();
// Use with Newman or Postman SDK
```
