...
description: "Create and manage API keys for secure programmatic access to UTMStack"
---
...
<Steps>
  <Step title="Navigate to Settings">
    ...
    <img src="/images/apidoc/api-keys-management.png" alt="API Keys Management Page" />
  </Step>
