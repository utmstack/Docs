---
title: Rules and Filters Overview
sidebarTitle: "Overview"
description: "Introduction to EventProcessor, Rules, and Filters - A practical reference for developers"
---

# Rules and Filters - Developer Reference
...
<AccordionGroup>
  <Accordion title="What are Rules?" icon="shield-check">
...
<AccordionGroup>
  <Accordion title="What are Filters?" icon="filter">
...
<Steps>
  ...
  <Step title="Parsing & Transformation">
  ...
  <Step title="Alert Correlation">
    Correlation plugins detect relationships between alerts
  </Step>
  
  <Step title="Notification & Storage">
...
<Steps>
  ...
  <Step title="Examine Sample Data">
    Collect and analyze sample events or logs
  </Step>
  
  <Step title="Create YAML Definition">
...
<CardGroup cols={2}>
  <Card title="Implementing Rules" icon="shield-check" href="/v11/rules-and-filters/implementing-rules">
  ...
  <Card title="Custom Plugins" icon="plug" href="/v11/rules-and-filters/custom-plugins">
    Develop custom plugins to extend EventProcessor functionality
  </Card>
  
  <Card title="Best Practices" icon="star" href="/v11/rules-and-filters/best-practices">
...
<CardGroup cols={2}>
  ...
  <Card title="Rules Repository" icon="git-alt" href="https://github.com/utmstack/rules">
