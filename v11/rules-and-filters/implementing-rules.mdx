---
title: Implementing Correlation Rules
sidebarTitle: "Implementing Rules"
description: "Complete guide for creating security detection rules in UTMStack v11 EventProcessor"
---
...
<AccordionGroup>
  ...
  <Accordion title="dataTypes" icon="database">
...
<AccordionGroup>
  <Accordion title="impact" icon="explosion">
    **Type**: Object  
    **Required**: Yes
  ...
  <Accordion title="technique" icon="screwdriver-wrench">
    **Type**: String  
    **Required**: Yes
  ...
  <Accordion title="adversary" icon="user-secret">
    **Type**: String  
    **Required**: Yes  
...
<CardGroup cols={2}>
  <Card title="filter_term" icon="equals">
    **Exact match** using term search (keyword fields)
    
    Best for: IPs, usernames, exact strings
  </Card>
  
  <Card title="filter_match" icon="magnifying-glass">
    **Full-text match** using text search
    
    Best for: Messages, descriptions, analyzed text
  </Card>
  
  <Card title="must_not_term" icon="ban">
    **Not equal** using term search
    
    Best for: Excluding specific values
  </Card>
  
  <Card title="must_not_match" icon="circle-xmark">
    **Not matching** using text search
    
    Best for: Excluding text patterns
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Write Where Condition">
  ...
  <Step title="Add Correlation Logic">
  ...
  <Step title="Configure Deduplication">
  ...
  <Step title="Document and Deploy">
...
<AccordionGroup>
  <Accordion title="Rule Not Triggering" icon="circle-question">
    **Possible Causes**:
  ...
  <Accordion title="Missing Field Errors" icon="file-circle-xmark">
    **Possible Causes**:
